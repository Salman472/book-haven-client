...
const Profile = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-sm mx-auto mt-20  backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 overflow-hidden p-6 text-center"
    >
      <motion.img
      ...
      <p className=" text-sm mb-2">{user?.role || "Frontend Developer"}</p>
